...
const groups = [
  ...
  { title: "Découvrir", links: [{ label: "Stations", href: "/stations" }, { label: "Destinations" }, { label: "Domaines skiables" }] },
  { title: "Météo & neige", links: [{ label: "Météo des stations", href: "/meteo" }, { label: "Prévisions neige" }, { label: "Webcams" }, { label: "Bulletins" }] },
  { title: "Pratique", links: [{ label: "Forfaits", href: "/forfaits" }, { label: "Contact", href: "/contact" }, { label: "Aide" }] },
